...
class Signin extends React.Component {
  ...
  onSubmitSignIn = () => {
    fetch('https://thawing-peak-51920.herokuapp.com/signin', {
      method: 'post',
          ...
          <div className="measure">
            ...
            <div className="">
              <input
                ...
                className="b ph3 pv2 input-reset ba b--black  white bg-transparent grow  br-pill pointer f6 dib"
                type="submit"
                value="Sign in"
              />
            </div>
            <div className="lh-copy mt3">
              <p  onClick={() => onRouteChange('register')} className="f6 link dim black white br-pill db pointer">Sign Up</p>
            </div>
          </div>
        </main>
      </article>
